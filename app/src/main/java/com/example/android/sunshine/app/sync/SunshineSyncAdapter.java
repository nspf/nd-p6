...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter
    ...
    public static final String SUNSHINE_DATA_TIMESTAMP = "sunshine_data_timestamp";
    ...
    private void updateWatchFace(double high, double low, int weatherId) {
        ...
        putDataMapRequest.getDataMap().putString(SUNSHINE_DATA_HIGH,
                Utility.formatTemperature(getContext(), high));
        putDataMapRequest.getDataMap().putString(SUNSHINE_DATA_LOW,
                Utility.formatTemperature(getContext(), low));
        putDataMapRequest.getDataMap().putLong(SUNSHINE_DATA_TIMESTAMP, new Date().getTime());

        int weatherCondition = Utility.getArtResourceForWeatherCondition(weatherId);
        Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(), weatherCondition);
